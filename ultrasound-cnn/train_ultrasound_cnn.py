...
train_test_pivot = int(0.7 * len(images))

x_train = images[:train_test_pivot]
x_test = images[train_test_pivot:]

y_train = images[:train_test_pivot]
y_test = images[train_test_pivot:]
...
def baseline_model():
    model = Sequential()
    model.add(Conv2D(32, (10, 10), input_shape = (1, 360, 360), activation='relu'))
